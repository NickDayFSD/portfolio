...
const fingerPaint = new URL('../assets/Paint.png', import.meta.url);
const globe = new URL('../assets/Globe.png', import.meta.url);
const marketScrape = new URL('../assets/Market.png', import.meta.url);
const tuneMatch = new URL('../assets/Music.png', import.meta.url);

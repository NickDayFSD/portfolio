...
export const projects = [{
  ...
  image: SOAK,
  description: ['A Progressive Web App with offline use designed to navigate weekend long event and festival schedules.', 'View by day with past event filtering. Favorite and filter out non-favorite events. Search by .']
}, {
  id: '4',
  title: 'Fingerpaint',
  ...
  image: fingerPaint,
  description: ['Fingerpaint: making digital design tools accessible and fun for your child.', 'At last, a mobile app that preliterate kids can enjoy right off the bat. Designed for children ages 2 - 5, Fingerpaint equips your child with basic design tools that are intuitive to navigate.', 'Fingerpaint is a Progressive Web App built using the React Framework and Material UI for the front-end components. We also utilized React-Canvas-Draw and React Color in order to make the canvas more accessible and appealing to young children.']
}, {
  id: '3',
  title: 'Tune Match',
  ...
  image: globe,
  description: ['Local Impact is a web app designed to show you some of the climate change factors in your area using ArcGIS maps from ESRI.', 'How is your area impacting climate change? What can you do to make an impact?', 'Whether you wish to make changes to your habits or legislature, we\'re here to help you figure out where to start.'],
  code: {
    front: `
    function MapView() {
